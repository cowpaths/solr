...
public class UpdateRequestHandler extends ContentStreamHandlerBase
  ...
  public void initializeMetrics(SolrMetricsContext parentContext, String scope) {
    ...
    metricsLocal = new HandlerMetrics(solrMetricsContext, getCategory().toString(), scope + LOCAL_HANDLER_SUFFIX);
  }
  ...
  public HandlerMetrics getMetricsForThisRequest(SolrQueryRequest req) {
    ...
    boolean isDistrib = req.getParams().getBool(CommonParams.DISTRIB,
