...
public final class BloomStrField extends StrField implements SchemaAware {
   ...
   * specified LeafReader. NOTE: the returned analyzer is determined by the associated segement,
   * and may differ from the bloom analyzer currently specified on the {@link #bloomFieldType} for
   * this {@link BloomStrField} field type.
   */
